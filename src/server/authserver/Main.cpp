...
int main(int argc, char** argv)
{
    ...
    _ioService = new Trinity::Asio::IoContext();
    ...
    std::unique_ptr<AsyncAcceptor> acceptor(new AsyncAcceptor(*_ioService, bindIp, port));
    sAuthSocketMgr.StartNetwork(std::move(acceptor));
