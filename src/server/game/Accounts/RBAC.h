...
enum RBACPermissions
{
    ...
    RBAC_PERM_RG_BEGIN__                                = 10000,

    RBAC_PERM_RG_LOGGING_TRACK_PACKETS                  = 10020,
    RBAC_PERM_RG_COMMAND_INSTANCE_UNLOAD_UNLOCKED       = 10032,
    RBAC_PERM_RG_COMMAND_QUEST_COMPLETE_UNLOCKED        = 10033,
    RBAC_PERM_RG_COMMAND_RESPAWN_AREA                   = 10036,
    RBAC_PERM_RG_COMMAND_UNAURA_ALL                     = 10040,
    RBAC_PERM_RG_MANAGE_PREMIUM_NPC                     = 10043,
    RBAC_PERM_RG_COMMAND_LEARN_ALL_SUPPORT              = 10044,

    RBAC_PERM_RG_PERMISSION_GROUPS_BEGIN__              = 11000,
    RBAC_PERM_RG_PERMISSION_GROUPS_END__                = 12000,

    // API

    // provider
    PERM_API_ACCOUNT_BASIC          = 20000,
    PERM_API_ACCOUNT_SECURITY       = 20001,
    PERM_API_ACCOUNT_PUNISHMENT     = 20002,

    PERM_API_CHARACTER_BASIC        = 20100,
    PERM_API_CHARACTER_STATUS       = 20101,

    PERM_API_GUILD_BASIC            = 20200,

    PERM_API_TICKET_BASIC           = 20300,

    // handler
    PERM_API_GENERAL_FEATURES       = 21000,

    PERM_API_EVENT_REGISTER         = 21100,

    PERM_API_ACCOUNT_SHOW           = 21200,

    PERM_API_CHARACTER_SHOW         = 21300,

    PERM_API_GUILD_SHOW             = 21400,

    PERM_API_TICKET_SHOW            = 21500,
    PERM_API_TICKET_LIST            = 21501,
    PERM_API_TICKET_EVENT_CREATE    = 21502,
    PERM_API_TICKET_EVENT_UPDATE    = 21503,
    PERM_API_TICKET_EVENT_CLOSE     = 21504,

    // max number of rbac permissions
    RBAC_PERM_MAX
};
