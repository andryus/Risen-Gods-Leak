...
{                                                           // value1         value2        comment
    ...
    ACHIEVEMENT_CRITERIA_DATA_TYPE_FSCRIPT             = 24  // 0                            queried from an fscript (encounter atm)
};

#define MAX_ACHIEVEMENT_CRITERIA_DATA_TYPE               25 // maximum value in AchievementCriteriaDataType enum
#define TIMER_DELAYED_ACHIEVEMENT_SET_COMPLETE           120000

constexpr uint32 ACHIEVEMENT_OVER_9K = 4496;
...
class GAME_API AchievementMgr
{
    public:
        ...
        void Reset();
        static void DeleteFromDB(ObjectGuid lowguid, uint32 achievementEntry = 0);
    ...
    private:
        ...
        void RemoveLinkedAchievements(uint32 achievementId);
        void RemoveAchievementRewards(uint32 achievementId);
...
class GAME_API AchievementGlobalMgr
{
    ...
    public:
        ...
        std::string_view GetAchievementCriteriaFScript(uint32 criteriaId) const;
        ...
        void LoadRealmFirstAchievements();
        void LoadRewards();
    ...
    private:
        ...
        std::set<uint32> _completedRealmFirstAchievements;
        ...
        std::unordered_map<uint32, std::string> criteriaFScripts;
};
