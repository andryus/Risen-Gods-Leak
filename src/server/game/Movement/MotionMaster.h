...
enum MovementGeneratorType
{
    ...
    FLIGHT_PATH_MOTION_TYPE = 17,                           // WaypointMovementGenerator.h
    NULL_MOTION_TYPE      = 18,
};
...
class GAME_API MotionMaster //: private std::stack<MovementGenerator *>
{
    private:
    ...
    public:
        ...
        void MoveConfused();
        void MoveFleeing(Unit* enemy, uint32 time = 0, bool run = 0);
        ...
        */
        void MoveCloserAndStop(uint32 id, Unit* target, float distance, float heigth = 0.0f);
        ...
        void MovePullTo(float x, float y, float z, float speedXY, float speedZ, uint32 id = EVENT_JUMP);
        ...
        void MovePath(WaypointPath const* path, bool repeatable);
        void MoveFlightPath(WaypointPath const* path, bool repeatable);
        void MoveScriptPath(uint32 path_id, bool repeatable, bool updatehomepos = false);
