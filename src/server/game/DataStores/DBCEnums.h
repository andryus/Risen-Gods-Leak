...
enum BattlegroundBracketId                                  // bracketId for level ranges
{
    ...
    BG_BRACKET_ID_LVL_80_SOLOQUEUE = 14,
...
enum Factions
{
    FACTION_NEUTRAL             = 15,                       // Creature - attack after getting an aggro impulse
    FACTION_HOSTILE             = 14,                       // Monster - attack player in aggro range
    FACTION_FRIENDLY_TO_ALL     = 35,                       // Friendly - attack nothing
    FACTION_HORDE_ALLIANCE      = 250
};
...
enum VehicleSeatFlags
{
    ...
    VEHICLE_SEAT_FLAG_SHOULD_USE_VEH_SEAT_EXIT_ANIM_ON_FORCED_EXIT     = 0x00008000, // VEHICLE_SEAT_FLAG_PASSENGER_NOT_ATTACKABLE ??
