...
class GAME_API SocialMgr
{
    ...
    public:
        ...
        // Packet management
        WorldPacket MakeFriendStatusPacket(FriendsResult result, ObjectGuid friend_guid);
        void SendFriendStatus(Player* player, FriendsResult result, ObjectGuid friend_guid, bool broadcast);
        void BroadcastToFriendListers(Player* player, const WorldPacket& packet);
        // Loading
