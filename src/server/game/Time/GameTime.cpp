...
namespace game::time
{
    ...
    thread_local time_t GameTime = 0;
    thread_local uint32 GameMSTime = 0;

    thread_local std::chrono::system_clock::time_point GameTimeSystemPoint = std::chrono::system_clock::time_point::min();
    thread_local std::chrono::steady_clock::time_point GameTimeSteadyPoint = std::chrono::steady_clock::time_point::min();
