...
typedef std::map<LfgRoles, uint8> LfgRolesNeededMap;

const LfgRolesNeededMap NEEDED_ALL_ROLES =
{
    std::make_pair(PLAYER_ROLE_TANK, LFG_TANKS_NEEDED),
    std::make_pair(PLAYER_ROLE_HEALER, LFG_HEALERS_NEEDED),
    std::make_pair(PLAYER_ROLE_DAMAGE, LFG_DPS_NEEDED)
};
...
typedef std::vector<LfgRolesMap> LfgRolesMapStore;
typedef std::multimap<LfgRoles, int32> LfgWaitTimesUpdate;
