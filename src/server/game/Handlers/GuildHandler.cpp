...
void WorldSession::HandleGuildRemoveOpcode(WorldPacket& recvPacket)
{
    ...
    if (normalizePlayerName(playerName))
    {
        ...
        sCalendarMgr->RemovePlayerGuildEventsAndSignups(player::PlayerCache::GetGUID(playerName), guildId);
    }
}
...
void WorldSession::HandleGuildLeaveOpcode(WorldPacket& /*recvPacket*/)
{
    ...
    sCalendarMgr->RemovePlayerGuildEventsAndSignups(GetPlayer()->GetGUID(), guildId);
}
