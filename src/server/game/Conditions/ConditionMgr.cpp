...
bool Condition::Meets(ConditionSourceInfo& sourceInfo) const
{
    ...
    switch (ConditionType)
    {
        ...
        {
            condMeets = object->FindNearestCreature(ConditionValue1, (float)ConditionValue2) ? true : false;
            break;
        }
        case CONDITION_NEAR_GAMEOBJECT:
        {
            condMeets = object->FindNearestGameObject(ConditionValue1, (float)ConditionValue2) ? true : false;
            break;
        }
