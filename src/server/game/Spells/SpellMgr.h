...
enum SpellDelayType
{
    SPELL_DELAY_TYPE_SPELLID = 0,
    SPELL_DELAY_TYPE_AURA_NAME = 1,
    SPELL_DELAY_TYPE_MECHANIC = 2,
    SPELL_DELAY_MAX_TYPES = 3,
};
...
using SpellPetAuraStore = std::unordered_map<uint32, uint32>;
...
class GAME_API SpellMgr
{
    ...
    public:
        ...
        std::optional<uint32> IsPetAura(uint32 auraId) const;
        ...
        span<SpellInfo*> _getAllSpells() const { return mSpellInfoMap; }
    ...
    private:
        ...
        SpellPetAuraStore          mSpellPetAuraStore;
