...
class GAME_API AuraScript : public _SpellScript
{
    ...
    public:
        ...
        // Important: If an OnEffectProc-Handler is called within ProcDamageAndSpellFor in Unit, block and resist values are inaccurate (just 0)
        // todo: Update procdamageandspell() everywhere to make correct block and resist results available
