...
enum QuestFlags
{
    ...
    QUEST_FLAGS_RAID                    = 0x00000040,   // PvP Quests can be rewarded with this flag -- Can be completed while in raid
    ...
    QUEST_FLAGS_ALWAYS_XP               = 0x00100000    // Alaways Enable XP at reward even if the quest is repeatable (and the player does not reached maxlevel)
