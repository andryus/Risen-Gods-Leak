...
#define BG_AV_SNOWFALL_FIRSTCAP          240000  //4:00 
...
horde:
    ...
    */
    ...
    AV_SOUND_ALLIANCE_CAPTAIN               = 8232, //gets called when someone attacks them and at the beginning after 3min+urand32(x)*10sec (maybe buff)
...
const float BG_AV_StaticCreaturePos[AV_STATICCPLACE_MAX][5] =
{
    ...
    {603.586f, -23.78f, 42.921f, 5.621853f, 39 }, //13816 - Prospector Stonehewer
...
const uint32 BG_AV_GraveyardsCapturedQuestReward = 13756;
const uint32 BG_AV_TowerCapturedQuestReward = 13778;
const uint32 BG_AV_MineCapturedQuestReward = 13796;
...
class BattlegroundAV : public Battleground
{
    ...
    private:
        ...
        /*mine*/
        void ChangeMineOwner(uint8 mine, uint32 team, bool initial=false, Creature* source = NULL);
