...
void BattlegroundDS::StartingEventOpenDoors()
{
    ...
    DelObject(BG_DS_READY_MARKER_H);
    DelObject(BG_DS_READY_MARKER_A);
}
...
bool BattlegroundDS::SetupBattleground()
{
    ...
    xH = 0; yH = 0; zH = 0; oH = 0; xA = 0; yA = 0; zA = 0; oA = 0;
    GetTeamStartLoc(HORDE, xH, yH, zH, oH);
    GetTeamStartLoc(ALLIANCE, xA, yA, zA, oA);
    if (!AddObject(BG_DS_READY_MARKER_H, GO_READY_MARKER, xH+1.8f, yH+2.2f, zH, oH, 0, 0, 0, 0, RESPAWN_IMMEDIATELY)
        || !AddObject(BG_DS_READY_MARKER_A, GO_READY_MARKER, xA+1.8f, yA+2.2f, zA, oA, 0, 0, 0, 0, RESPAWN_IMMEDIATELY))
    {
        TC_LOG_ERROR("sql.sql", "BatteGroundDS: Failed to spawn ready-marker!");
        return false;
    }
