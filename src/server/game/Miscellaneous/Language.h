...
enum TrinityStrings
{
    ...
    LANG_BG_QUEUE_ANNOUNCE_CROSSFACTION_SELF  = 130050,
    LANG_BG_QUEUE_ANNOUNCE_CROSSFACTION_WORLD = 130051,
...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_GM_SILENCE                      = 6616,              // OBSOLETE "Silence is ON for %s" - Spell 1852
    ...
    LANG_ANTI_CHEAT_ENGINE              = 20000,
    LANG_ANTI_CHEAT_ENGINE_WARDEN       = 20001,
    LANG_COMMAND_TICKETNEW_VIP          = 20030,
    LANG_COMMAND_TICKETLISTNAME_VIP     = 20031,
    ...
    LANG_FACTION_CHANGE_GUILD_ERROR         = 20020,
    LANG_FACTION_CHANGE_AUCTION_ERROR       = 20021,
    LANG_FACTION_CHANGE_POST_ERROR          = 20022,
    LANG_FACTION_CHANGE_ARENA_ERROR         = 20023,

    //###################################
    //### Commands (3X.XXX)
    //###################################
    // Command: General (30.XXX)
    LANG_COMMAND_NOT_AVAILABLE              = 30000,
    LANG_COMMAND_NOT_FOUND                  = 30001,
    LANG_COMMAND_AVAILABLE_COMMANDS         = 30002,
    LANG_COMMAND_AVAILABLE_SUBCOMMANDS      = 30003,
    LANG_COMMAND_AVAILABLE_SUBCOMMANDS_FOR  = 30004,
    LANG_COMMAND_AMBIGUOUS                  = 30005,
    LANG_COMMAND_LIST_FORMAT                = 30006,
    LANG_COMMAND_EXECUTION_FAILED           = 30007,
    LANG_COMMAND_NOT_ALLOWED                = 30008,
    LANG_COMMAND_MISSING_ARGUMENT           = 30009,
    LANG_COMMAND_INVALID_ARGUMENT           = 30010,

    // Command: Stuff related to specific commands (31.000 - 39.999)
    LANG_COMMAND_HELP_TEXT                  = 31000,

    //###################################
    //### Misc (120.000 - 1.999.999.999)
    //###################################
    LANG_CANNOT_REMOVE_ITEM                 = 120006,

    LANG_HAS_NORMAL_QUEST_XP                = 120007,
    LANG_HAS_DOUBLE_QUEST_XP                = 120008,

    LANG_PLAYER_HAS_FOLLOWING_ITEMS_EQUIPT  = 120009,
    LANG_PLAYER_ITEM_EQUIP_SLOT             = 120010,

    LANG_CHAR_NOT_FOUND                         = 120011,
    LANG_CHAR_HAS_NOT_ENOUGH_GOLD               = 120012,
    LANG_CHAR_CANT_GIVE_BECOUSE_TO_MUCH_MONEY   = 120013,

    LANG_ACCOUNT_VERIFY_CODE                = 120014,
    
    LANG_GM_ONLY_VISIBLE_FOR_GMS            = 120018,

    // RG - Misc
    LANG_MISSING_ACHIEVEMENT_ICC            = 130016,
    LANG_NOT_ENOUGH_MONEY_TO_TAKE           = 130017,
    LANG_AI_NOT_ENABLED                     = 130018,
    LANG_COMMAND_INVALID_PARAMETER          = 130019,
    LANG_COMMAND_ACTION_FAILED              = 130020,
    LANG_COMMAND_INSTANCE_UNLOAD_NOT_LEAD           = 130022,
    LANG_COMMAND_INSTANCE_UNLOAD_MAP_NOT_LOADED     = 130023,
    LANG_COMMAND_INSTANCE_UNLOAD_NOT_AN_INSTANCE    = 130024,
    LANG_COMMAND_INSTANCE_UNLOAD_NOT_EMPTY          = 130025,
    LANG_COMMAND_INSTANCE_UNLOAD_NOT_RAID           = 130026,
    LANG_COMMAND_INSTANCE_UNLOAD_SUCCESSFUL         = 130028,
    LANG_COMMAND_INSTANCE_UNLOAD_ID_NOT_FOUND       = 130029,
    LANG_COMMAND_INSTANCE_UNLOAD_FAILED             = 130030,
    LANG_COMMAND_QUEST_COMPLETE_NOT_WHITELISTED     = 130031,
    LANG_BG_SA_BLUE_GATE_DESTROYED                  = 130032,
    LANG_BG_SA_GREEN_GATE_DESTROYED                 = 130033,
    LANG_BG_SA_PURPLE_GATE_DESTROYED                = 130034,
    LANG_BG_SA_RED_GATE_DESTROYED                   = 130035,
    LANG_BG_SA_YELLOW_GATE_DESTROYED                = 130036,
    LANG_BG_SA_ANCIENT_GATE_DESTROYED               = 130037,
    LANG_COMMAND_INSTANCE_UNLOAD_COOLDOWN           = 130038,
    // SAY_OFFER                                    = 130039,
    LANG_RG_BIRTHDAY_MAIL_TITLE                     = 130040,
    LANG_RG_BIRTHDAY_MAIL_TEXT                      = 130041,
    LANG_COMPLAIN_NOTIFY                            = 130042,
    LANG_COMMAND_BGINFO_NOT_IN_QUEUE                = 130052,
    LANG_JOIN_START_GUILD_NOTICE                    = 130055,
    LANG_CROSSFACTION_ENABLED                       = 130056,
    LANG_CROSSFACTION_DISABLED                      = 130057,
    LANG_ARENA_REPLAY_DISABLED                      = 130058,
    LANG_ARENA_REPLAY_INTERNAL_ERROR                = 130059,
    LANG_ARENA_REPLAY_SAVED                         = 130060,
    LANG_ARENA_REPLAY_NOT_FOUND                     = 130061,
    LANG_ARENA_REPLAY_NOT_YET_AVAILABLE             = 130062,
    LANG_ARENA_REPLAY_NO_REPLAYS_FOUND              = 130063,
    LANG_ARENA_REPLAY_CANT_WATCH_OWN_MATCHES        = 130064,
    LANG_COMMAND_SCRIPT_MISSING                     = 130065,

    LANG_SERVERINFO_WORLD_DIFFTIME                  = 130070,
    LANG_SERVERINFO_MAP_DIFFTIME                    = 130071,

    LANG_ARENA_SOLO_QUEUE_DISABLED                  = 130072,
    LANG_ARENA_SOLO_QUEUE_ERROR_IN_GROUP            = 130073,
    
    LANG_PREMIUM_RENAME_SUCCESS                     = 130074,
    LANG_PREMIUM_CUSTOMIZE_SUCCESS                  = 130075,
    LANG_PREMIUM_RACECHANGE_SUCCESS                 = 130076,
    LANG_PREMIUM_FACTIONCHANGE_SUCCESS              = 130077,
    LANG_PREMIUM_PET_SUCCESS                        = 130078,
    LANG_PREMIUM_TRADINGCARDGOODS_SUCCESS           = 130079,
    LANG_PREMIUM_RACECHANGE_FAIL                    = 130080,
    LANG_PREMIUM_FACTIONCHANGE_FAIL_ARENA           = 130081,
    LANG_PREMIUM_FACTIONCHANGE_FAIL_POST            = 130082,
    LANG_PREMIUM_FACTIONCHANGE_FAIL_AUCTIONS        = 130083,
    LANG_PREMIUM_FACTIONCHANGE_FAIL_GUILD           = 130084,
    LANG_PREMIUM_TRADINGCARD_MULTI                  = 130085,
    LANG_PREMIUM_GM_RELEASE_PLAYER_LOCK_SUCCESS     = 130086,
    LANG_PREMIUM_GM_RELEASE_PLAYER_LOCK_FAIL        = 130087,
    
    LANG_CONNECTED_PLAYERS_COLORED                  = 130091,
    LANG_CONNECTED_USERS_COLORED                    = 130092,
    LANG_UPTIME_COLORED                             = 130093,
    LANG_SERVERINFO_WORLD_DIFFTIME_COLORED          = 130094,
};
#endif
