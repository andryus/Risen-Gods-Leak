...
enum SpellSchoolMask
{
    ...
    // 126, includes everything except normal and none
...
enum SpellAttr5
{
    ...
    SPELL_ATTR5_REDUCED_BY_AOE_DAMAGE_AVOIDANCE  = 0x00008000, // 15 damage is recuced by aoe damage avoidance auras
...
enum SpellAttr6
{
    ...
    SPELL_ATTR6_DEATHGRIP                        = 0x10000000, // 28 Only death grip as his attribute
...
enum GameObjectFlags
{
    ...
    GO_FLAG_IS_PORTAL         = 0x00002000                    // Gameobject is Portal
};
...
/// Ban functions return codes
enum BanResult
{
    BAN_SUCCESS, ///< the ban operation was successful
    BAN_SYNTAX_ERROR, ///< the ban operation failed because of a syntax error
    BAN_NOTFOUND, ///< the ban operation failed because the ban target could not be found
};
...
enum BattlegroundQueueTypeId
{
    ...
    BATTLEGROUND_QUEUE_MIXED_BG = 11,
    BATTLEGROUND_QUEUE_SOLO_ARENA = 12,
