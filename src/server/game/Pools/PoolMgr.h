...
class GAME_API PoolMgr
{
    ...
    private:
        ...
        uint32 max_pool_id;
        typedef std::map<uint32, PoolTemplateData>       PoolTemplateDataMap;
        typedef std::map<uint32, PoolGroup<Creature> >   PoolGroupCreatureMap;
        typedef std::map<uint32, PoolGroup<GameObject> > PoolGroupGameObjectMap;
        typedef std::map<uint32, PoolGroup<Pool> >       PoolGroupPoolMap;
        typedef std::map<uint32, PoolGroup<Quest> >      PoolGroupQuestMap;
