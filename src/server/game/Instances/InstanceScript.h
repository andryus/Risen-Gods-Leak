...
typedef GuidSet DoorSet;
typedef GuidSet MinionSet;
...
class GAME_API InstanceScript : public ZoneScript
{
    public:
        ...
        virtual void OnPlayerRemove(Player* /*player*/) { }

        // Called when a pet successfully enters the instance.
        virtual void OnPetEnter(Pet* /*pet*/) {}
        virtual void OnPetRemove(Pet* /*pet*/) {}

        //Called when a player successfully logged in, in an instance
        virtual void OnPlayerLoggedIn(Player* /*player*/) { }
        ...
        //weather in instances
        void DoUpdateWeatherForPlayer(Player* player, WeatherState weather, float grade, uint8 unkBit = 0);
        virtual WeatherState GetWeatherStateInInstance(uint32 /*zoneID*/) { return WEATHER_STATE_FINE; }
        virtual float GetWeatherGradeInInstance(uint32 /*zoneID*/) { return 0.0f; }

        // Send Notify to all players in instance
        void DoSendNotifyToInstance(char const* format, ...);

        // Complete Criteria from achievement for all players in instance
        void DoCompleteCriteria(uint32 achievement);
        ...
        void DoRemoveAurasDueToSpellOnPlayers(uint32 spell, AuraRemoveMode removeMode = AURA_REMOVE_BY_DEFAULT);

        void DoRemoveAurasOnPlayerAndPets(uint32 spell, AuraRemoveMode removeMode = AURA_REMOVE_BY_DEFAULT);
