...
void WardenWin::InitializeModule()
{
    ...
    _session->SendPacket(std::move(pkt));
}
...
void WardenWin::HandleHashResult(ByteBuffer &buff)
{
    ...
    _previousTimestamp = game::time::GetGameTimeMS();
}
...
void WardenWin::RequestData()
{
    ...
    _serverTicks = game::time::GetGameTimeMS();
...
void WardenWin::HandleData(ByteBuffer &buff)
{
    ...
    // TIMING_CHECK
    {
        ...
        uint32 ticksNow = game::time::GetGameTimeMS();
    ...
    for (std::list<uint16>::iterator itr = _currentChecks.begin(); itr != _currentChecks.end(); ++itr)
    {
        ...
        switch (type)
        {
            ...
            case LUA_STR_CHECK:
            {
                ...
                buff.skip(luaStrLen);         // Skip string
    ...
    if (checkFailed > 0)
    {
        ...
        AntiCheat::LogWardenAction(_session, check);
    }
