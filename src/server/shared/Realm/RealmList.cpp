...
void RealmList::Initialize(Trinity::Asio::IoContext& ioContext, uint32 updateInterval, std::function<PreparedQueryResult()> realmQuery)
{
    _updateInterval = updateInterval;
    _updateTimer = new boost::asio::deadline_timer(ioContext);
    _resolver = new boost::asio::ip::tcp::resolver(ioContext);
    _realmQuery = std::move(realmQuery);
...
void RealmList::UpdateRealms(boost::system::error_code const& error)
{
    ...
    PreparedQueryResult result = _realmQuery();
