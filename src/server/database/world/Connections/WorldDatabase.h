...
enum WorldDatabaseStatements
{
    ...
    */
    ...
    WORLD_LOAD_FAC_CHANGE_TITLES,
    WORLD_LOAD_ITEMS_FOR_QUEST,
    WORLD_LOAD_FAC_CHANGE_HOMEBIND,
    WORLD_LOAD_QUEST_RACE,
...
public:
    ...
    WorldDatabaseConnection(MySQLConnectionInfo& connInfo) : MySQLConnection(connInfo, "World") { }
