...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_INS_RESERVED_NAME,
    CHAR_DEL_RESERVED_NAME,
    ...
    CHAR_SEL_AUCTIONS,
    CHAR_INS_PENDING_SALE,
    CHAR_DEL_PENDING_SALE,
    CHAR_INS_MAIL,
    CHAR_DEL_MAIL_BY_ID,
    CHAR_INS_MAIL_ITEM,
    CHAR_DEL_MAIL_ITEM,
    ...
    CHAR_SEL_CHARACTER_REALM_RECORD,
    CHAR_UPD_NAME,
    ...
    CHAR_SEL_ACCOUNT_COMPLAINTS,
    CHAR_REP_ACCOUNT_COMPLAINTS,
    ...
    CHAR_INS_INSTANCE_ENCOUNTER_SAVE,
    CHAR_SEL_INSTANCE_ENCOUNTER_STATE,
    CHAR_DEL_INSTANCE_ENCOUNTERS,

    CHAR_INS_INSTANCE_EVENT_SAVE,
    CHAR_SEL_INSTANCE_EVENT_STATE,
    CHAR_DEL_INSTANCE_EVENTS,
    ...
    CHAR_SEL_OPEN_TICKETS,
    CHAR_SEL_MAX_TICKET_ID,
    CHAR_REP_TICKET,
    CHAR_DEL_TICKETS_BY_AUTHOR,
    CHAR_DEL_ALL_GM_TICKETS,

    CHAR_SEL_MAX_SURVEY_ID,
    CHAR_INS_TICKET_SURVEY,
    CHAR_INS_TICKET_SUBSURVEY,
    CHAR_INS_LAG_REPORT,
    ...
    CHAR_SEL_CHECK_FACTIONCHANGE,
    CHAR_UPD_CURR_TITLE,
    CHAR_UPD_TITLE_MASK,
    CHAR_SEL_KNOWN_TITLES,
    CHAR_SEL_QUEST_STATUS,
    CHAR_SEL_QUEST_ITEM_ITEM_INSTANCE,
    CHAR_DEL_QUEST_ITEM_FROM_INVENTORY,
    CHAR_DEL_QUEST_ITEM_FROM_ITEM_INSTANCE,
    CHAR_DEL_GUILD_SURCOAT,
    CHAR_DEL_ARENA_STATS,
    CHAR_LOAD_PLAYER_QUEST_REW,
    CHAR_DEL_PLAYER_QUEST_REW,
    CHAR_UPD_PLAYER_QUEST_REW,
    CHAR_INS_PLAYER_QUEST_REW,
    CHAR_SEL_PLAYER_QUEST_REW,

    CHAR_SEL_CUSTOM_FLAGS,
    CHAR_INS_CUSTOM_FLAGS,
    CHAR_DEL_CUSTOM_FLAGS,
    ...
    CHAR_INS_PVPSTATS_BATTLEGROUND_WITH_ID,
    CHAR_INS_PVPSTATS_PLAYER,
    CHAR_SEL_PVPSTATS_FACTIONS_OVERALL,

    CHAR_SEL_CURRENT_EQUIP,

    CHAR_DEL_CREATURE_VENDOR_ITEM_COUNT,
    CHAR_REP_CREATURE_VENDOR_ITEM_COUNT,
    
    CHAR_SEL_TEMP_INSTANCE,
    CHAR_INS_TEMP_INSTANCE,
    ...
    CHAR_SEL_PLAYER_CACHE,
    CHAR_SEL_PLAYER_CACHE_BY_GUID,

    CHAR_SEL_MAILS,
    CHAR_SEL_MAIL_ITEMS,
    CHAR_SEL_MAIL_ITEMS_FOR_RETURN,
    CHAR_UPD_MAIL_MARK_AS_READ,
    CHAR_UPD_MAIL_MARK_AS_COPIED,
    CHAR_UPD_MAIL_TAKE_MONEY,

    CHAR_SEL_PVP_RANK_ALLIANCE,
    CHAR_SEL_PVP_RANK_HORDE,
    CHAR_SEL_PVP_RANK_BY_GUID,
    CHAR_REP_PVP_RANK,
    CHAR_DEL_PVP_RANK,
    CHAR_UPD_PVP_ARENA_STATS,

    CHAR_SEL_ARMORY_ARENA_GAMES_MAXID,
    CHAR_INS_ARMORY_ARENA_GAMES,

    CHAR_INS_ARENAREPLAY_DATA,
    CHAR_INS_ARENAREPLAY_CHAR_DATA,

    MAX_CHARACTERDATABASE_STATEMENTS
};

class DB_API CharacterDatabaseConnection : public MySQLConnection
{
public:
    typedef CharacterDatabaseStatements Statements;

    //- Constructors for sync and async connections
    CharacterDatabaseConnection(MySQLConnectionInfo& connInfo) : MySQLConnection(connInfo, "Char") { }
    CharacterDatabaseConnection(ProducerConsumerQueue<SQLOperation*>* q, MySQLConnectionInfo& connInfo) :
            MySQLConnection(q, connInfo, "Char")
    {}
