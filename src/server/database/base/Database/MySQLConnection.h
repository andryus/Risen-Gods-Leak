...
namespace RG { namespace Rebase { class ItemRebase; }}
namespace RG { namespace Monitoring { class DatabaseCounter; }}
...
class MySQLConnection
{
    ...
    friend class RG::Rebase::ItemRebase;

    public:
        MySQLConnection(MySQLConnectionInfo& connInfo, const std::string& name);                               //! Constructor for synchronous connections.
        MySQLConnection(ProducerConsumerQueue<SQLOperation*>* queue, MySQLConnectionInfo& connInfo, const std::string& name);  //! Constructor for asynchronous connections.
...
#ifdef CONFIG_WITH_PROMETHEUS_MONITORING
        RG::Monitoring::DatabaseCounter* monitoring_counter_ = nullptr;
#endif
};
