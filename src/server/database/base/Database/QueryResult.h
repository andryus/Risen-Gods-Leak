...
using QueryResult       = std::unique_ptr<ResultSet>;
using SharedQueryResult = std::shared_ptr<ResultSet>;
...
using PreparedQueryResult       = std::unique_ptr<PreparedResultSet>;
using SharedPreparedQueryResult = std::shared_ptr<PreparedResultSet>;
