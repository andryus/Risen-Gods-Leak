...
class PreparedStatement
{
    ...
    public:
        ...
        void setString(const uint8 index, std::string_view value);
...
typedef folly::Future<PreparedQueryResult> PreparedQueryResultFuture;
typedef folly::Promise<PreparedQueryResult> PreparedQueryResultPromise;
...
class PreparedStatementTask : public SQLOperation
{
    public:
        ...
        bool Execute();
        PreparedQueryResultFuture GetFuture() { return m_result->getFuture(); }
