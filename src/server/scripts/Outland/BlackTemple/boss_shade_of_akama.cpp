    ...
    struct boss_shade_of_akamaAI : public BossAI
    {
        ...
        void Reset() override
        {
            ...
            if (!HasKilledAkamaAndReseting)
            {
                ...
                for (std::list<ObjectGuid>::const_iterator itr = Spawners.begin(); itr != Spawners.end(); ++itr)
        ...
        void UpdateSpeed()
        {
            ...
            if (me->GetAuraCount(SPELL_SHADE_SOUL_CHANNEL_2) <= 3)
            {
                ...
                me->SetSpeedRate(MOVE_WALK, moveSpeed / 2.5);
