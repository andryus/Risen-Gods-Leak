    ...
    struct boss_darkweaver_sythAI : public BossAI
    {
        ...
        void SythSummoning()
        {
            ...
            if (me->IsNonMeleeSpellCast(false))
                ...
                me->SummonCreature(NPC_SYTH_ARCANE, me->GetPositionX(), me->GetPositionY()+1, me->GetPositionZ(), 0, TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 180 * IN_MILLISECONDS);
                me->SummonCreature(NPC_SYTH_FIRE, me->GetPositionX(), me->GetPositionY()-1, me->GetPositionZ(), 0, TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 180 * IN_MILLISECONDS);
                me->SummonCreature(NPC_SYTH_FROST, me->GetPositionX()-1, me->GetPositionY(), me->GetPositionZ(), 0, TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 180 * IN_MILLISECONDS);
                me->SummonCreature(NPC_SYTH_SHADOW, me->GetPositionX()+1, me->GetPositionY(), me->GetPositionZ(), 0, TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 180 * IN_MILLISECONDS);
