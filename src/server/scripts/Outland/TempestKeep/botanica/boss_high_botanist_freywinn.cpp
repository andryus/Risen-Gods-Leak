    ...
    public:
        ...
        struct boss_high_botanist_freywinnAI : public BossAI
        {
            ...
            void DoSummonSeedling()
            {
                switch (rand32() % 4)
                {
                    case 0: DoCastSelf(SPELL_PLANT_WHITE); break;
                    case 1: DoCastSelf(SPELL_PLANT_GREEN); break;
                    case 2: DoCastSelf(SPELL_PLANT_BLUE); break;
                    case 3: DoCastSelf(SPELL_PLANT_RED); break;
                }
            }
