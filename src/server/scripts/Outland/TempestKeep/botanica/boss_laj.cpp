    ...
    public:
        ...
        struct boss_lajAI : public BossAI
        {
            ...
            void DoSummons()
            {
                ...
                {
                    case 0:
                        DoCastSelf(SPELL_SUMMON_LASHER_1, true);
                        DoCastSelf(SPELL_SUMMON_FLAYER_1, true);
                        break;
                    case 1:
                        DoCastSelf(SPELL_SUMMON_LASHER_2, true);
                        DoCastSelf(SPELL_SUMMON_FLAYER_2, true);
                        break;
                    case 2:
                        DoCastSelf(SPELL_SUMMON_LASHER_3, true);
                        DoCastSelf(SPELL_SUMMON_FLAYER_3, true);
                        break;
                    case 3:
                        DoCastSelf(SPELL_SUMMON_LASHER_4, true);
                        DoCastSelf(SPELL_SUMMON_FLAYER_4, true);
                        break;
                }
                CanSummon = false;
            }
