...
class spell_lethon_shadow_bolt_whirl : public SpellScriptLoader
{
    public:
        spell_lethon_shadow_bolt_whirl() : SpellScriptLoader("spell_lethon_shadow_bolt_whirl") { }

        class spell_lethon_shadow_bolt_whirl_AuraScript : public AuraScript
        {
            PrepareAuraScript(spell_lethon_shadow_bolt_whirl_AuraScript);
            ...
            void HandleEffectPeriodic(AuraEffect const* /*aurEff*/)
            {
                ...
                if (auto eff = GetEffect(EFFECT_0))
                {
                    ...
                    uint32 tick = (eff->GetTickNumber() + 7/*-1*/) % 8;
                    ...
                    target->CastSpell(target, spellForTick[tick], TRIGGERED_FULL_MASK, NULL, eff, GetCasterGUID());
            ...
            {
                 OnEffectPeriodic += AuraEffectPeriodicFn(spell_lethon_shadow_bolt_whirl_AuraScript::HandleEffectPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
            }
        };

        AuraScript* GetAuraScript() const override
        {
            return new spell_lethon_shadow_bolt_whirl_AuraScript();
        }
};
        ...
        struct boss_taerarAI : public emerald_dragonAI
        {
            ...
            void JustSummoned(Creature* summon) override
            {
                if (summon->GetEntry() == NPC_TAERAR_SHADE)
                {
                    ...
                    emerald_dragonAI::JustSummoned(summon);
            }
...
void AddSC_emerald_dragons()
{
    ...
    new spell_lethon_shadow_bolt_whirl();
};
