...
class achievement_bg_wrecking_ball : public AchievementCriteriaScript
{
    public:
        achievement_bg_wrecking_ball() : AchievementCriteriaScript("achievement_bg_wrecking_ball") { }
        ...
        bool OnCheck(Player* source, Unit* /*target*/)
        {
            ...
            {
                uint32 killingBlows = battleground->GetPlayerScore(source, SCORE_KILLING_BLOWS);
                uint32 deaths       = battleground->GetPlayerScore(source, SCORE_DEATHS);

                if (killingBlows >= 20 && deaths == 0)
                    return true;
            }
            return false;
        }
...
class achievement_city_defender : public AchievementCriteriaScript
{
    public:
        achievement_city_defender() : AchievementCriteriaScript("achievement_city_defender") { }
