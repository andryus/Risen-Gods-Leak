...
void OPvPCapturePointEP_EWT::ChangeState()
{
    ...
    GameObject* flag2 = nullptr;
    if (m_capturePoint)
    {
        m_capturePoint->SetGoArtKit(artkit);
        flag2 = m_capturePoint->GetMap()->GetGameObject(m_Objects[EP_EWT_FLAGS]);
    }
    if (flag2)
    {
...
void OPvPCapturePointEP_NPT::ChangeState()
{
    ...
    {
        m_capturePoint->SetGoArtKit(artkit);
        flag2 = m_capturePoint->GetMap()->GetGameObject(m_Objects[EP_NPT_FLAGS]);
    }
    if (flag2)
    {
        flag2->SetGoArtKit(artkit);
...
void OPvPCapturePointEP_NPT::SummonGO(uint32 team)
{
    if (m_SummonedGOSide != team)
    {
        ...
        if (m_capturePoint)
            if (GameObject* go = m_capturePoint->GetMap()->GetGameObject(m_Objects[EP_NPT_BUFF]))
...
void OPvPCapturePointEP_CGT::ChangeState()
{
    ...
    {
        m_capturePoint->SetGoArtKit(artkit);
        flag2 = m_capturePoint->GetMap()->GetGameObject(m_Objects[EP_CGT_FLAGS]);
    }
    if (flag2)
    {
        flag2->SetGoArtKit(artkit);
...
void OPvPCapturePointEP_PWT::ChangeState()
{
    ...
    {
        m_capturePoint->SetGoArtKit(artkit);
        flag2 = m_capturePoint->GetMap()->GetGameObject(m_Objects[EP_PWT_FLAGS]);
    }
    if (flag2)
    {
        flag2->SetGoArtKit(artkit);
