...
public:
    ...
    struct boss_aranAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            instance->HandleGameObject(ObjectGuid(instance->GetGuidData(DATA_GO_LIBRARY_DOOR)), true);
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            instance->HandleGameObject(ObjectGuid(instance->GetGuidData(DATA_GO_LIBRARY_DOOR)), false);
        }
