...
public:
    ...
    struct netherspite_infernalAI : public ScriptedAI
    {
        netherspite_infernalAI(Creature* creature) : ScriptedAI(creature),
            HellfireTimer(0), CleanupTimer(0), malchezaar(), point(NULL) { }
...
public:
    ...
    struct boss_malchezaarAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            instance->HandleGameObject(ObjectGuid(instance->GetGuidData(DATA_GO_NETHER_DOOR)), true);
        }
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            instance->HandleGameObject(ObjectGuid(instance->GetGuidData(DATA_GO_NETHER_DOOR)), false); // Open the door leading further in
        }
