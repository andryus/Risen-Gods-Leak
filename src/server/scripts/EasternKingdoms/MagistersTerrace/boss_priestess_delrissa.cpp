...
public:
    ...
    struct boss_priestess_delrissaAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            if (GameObject* door = me->FindNearestGameObject(GO_DELRISSA_DOOR, 500.0f))
...
struct boss_priestess_lackey_commonAI : public ScriptedAI
{
    ...
    void Reset() override
    {
        ...
        if (Creature* pDelrissa = ObjectAccessor::GetCreature(*me, ObjectGuid(instance->GetGuidData(DATA_DELRISSA))))
        {
    ...
    void JustDied(Unit* /*killer*/) override
    {
        Creature* pDelrissa = ObjectAccessor::GetCreature(*me, ObjectGuid(instance->GetGuidData(DATA_DELRISSA)));
    ...
    void KilledUnit(Unit* victim) override
    {
        if (Creature* Delrissa = ObjectAccessor::GetCreature(*me, ObjectGuid(instance->GetGuidData(DATA_DELRISSA))))
...
public:
    ...
    struct boss_apokoAI : public boss_priestess_lackey_commonAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (Totem_Timer <= diff)
            {
                DoCastSelf(RAND(SPELL_WINDFURY_TOTEM, SPELL_FIRE_NOVA_TOTEM, SPELL_EARTHBIND_TOTEM));
                ++Totem_Amount;
            ...
            {
                DoCastSelf(SPELL_LESSER_HEALING_WAVE);
                Healing_Wave_Timer = 5000;
...
public:
    ...
    struct boss_zelfanAI : public boss_priestess_lackey_commonAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            {
                DoCastSelf(SPELL_HIGH_EXPLOSIVE_SHEEP);
