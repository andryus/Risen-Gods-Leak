...
public:
    ...
    struct boss_felblood_kaelthasAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            if (GameObject* escapeOrb = ObjectAccessor::GetGameObject(*me, ObjectGuid(instance->GetGuidData(DATA_ESCAPE_ORB))))
...
public:
    ...
    struct npc_felkael_flamestrikeAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            DoCastSelf(SPELL_FLAMESTRIKE2, true);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            if (FlameStrikeTimer <= diff)
            {
                DoCastSelf(SPELL_FLAMESTRIKE1_NORMAL, true);
                me->KillSelf();
            } else FlameStrikeTimer -= diff;
        }
    };
...
public:
    ...
    struct npc_felkael_phoenixAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            DoCastSelf(SPELL_PHOENIX_BURN, true);
            BurnTimer = 2000;
            Death_Timer = 3000;
            Rebirth = false;
            FakeDeath = false;
