    ...
    public: boss_arlokk() : CreatureScript("boss_arlokk") { }
        ...
        struct boss_arlokkAI : public BossAI
        {
            ...
            void EnterCombat(Unit* who) override
            {
                ...
                me->GetCreatureListWithEntryInGrid(triggerList, NPC_PANTHER_TRIGGER, 100.0f);
            ...
            void EnterEvadeMode(EvadeReason /*why*/) override
            {
                ...
                if (GameObject* object = ObjectAccessor::GetGameObject(*me, ObjectGuid(instance->GetGuidData(GO_GONG_OF_BETHEKK))))
    ...
    public: npc_zulian_prowler() : CreatureScript("npc_zulian_prowler") { }
        ...
        struct npc_zulian_prowlerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                DoCastSelf(SPELL_SNEAK_RANK_1_1);
                DoCastSelf(SPELL_SNEAK_RANK_1_2);

                if (Unit* arlokk = ObjectAccessor::GetUnit(*me, ObjectGuid(_instance->GetGuidData(NPC_ARLOKK))))
