                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_POWERFULL_HEALING_WARD:
                            DoCastSelf(SPELL_POWERFULL_HEALING_WARD);
    ...
    public:
        ...
        struct npc_healing_wardAI : public ScriptedAI
        {
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                if (Heal_Timer <= diff)
                {
                    if (Unit* jindo = ObjectAccessor::GetUnit(*me, ObjectGuid(instance->GetGuidData(DATA_JINDO))))
    ...
    public:
        ...
        struct npc_shade_of_jindoAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                DoCastSelf(SPELL_INVISIBLE, true);
            }
