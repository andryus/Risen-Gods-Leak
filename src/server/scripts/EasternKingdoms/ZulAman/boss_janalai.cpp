        ...
        //        DoZoneInCombat();
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                if (BombTimer <= diff)
                {
                    ...
                    me->StopMoving();
                    DoCastSelf(SPELL_FIRE_BOMB_CHANNEL, false);
                    //DoTeleportPlayer(me, JanalainPos[0][0], JanalainPos[0][1], JanalainPos[0][2], 0);
                    //DoCastSelf(SPELL_TELE_TO_CENTER, true);
                    ...
                    for (Player& player : map->GetPlayers())
                        if (player.IsAlive())
                            DoTeleportPlayer(&player, JanalainPos[0][0] - 5 + rand32() % 10, JanalainPos[0][1] - 5 + rand32() % 10, JanalainPos[0][2], 0);
                ...
                if (!noeggs)
                {
                    if (HealthBelowPct(35))
                    {
                        ...
                        DoTeleportTo(JanalainPos[0][0], JanalainPos[0][1], JanalainPos[0][2]);
                        me->StopMoving();
                        DoCastSelf(SPELL_HATCH_ALL, false);
                        HatchAllEggs(2);
                        noeggs = true;
                    }
