    ...
    public:
        ...
        struct boss_archaedasAI : public ScriptedAI
        {
            ...
            void UpdateAI(uint32 uiDiff) override
            {
                ...
                {
                    bWakingUp = false;
                    AttackStart(ObjectAccessor::GetUnit(*me, ObjectGuid(instance->GetGuidData(0))));
                    Talk(SAY_AGGRO);
                ...
                {
                    ActivateMinion(ObjectGuid(instance->GetGuidData(5)), true);   // EarthenGuardian1
                    ActivateMinion(ObjectGuid(instance->GetGuidData(6)), true);   // EarthenGuardian2
                    ActivateMinion(ObjectGuid(instance->GetGuidData(7)), true);   // EarthenGuardian3
                    ActivateMinion(ObjectGuid(instance->GetGuidData(8)), true);   // EarthenGuardian4
                    ActivateMinion(ObjectGuid(instance->GetGuidData(9)), true);   // EarthenGuardian5
                    ActivateMinion(ObjectGuid(instance->GetGuidData(10)), false); // EarthenGuardian6
                ...
                {
                    ActivateMinion(ObjectGuid(instance->GetGuidData(1)), true);    // VaultWalker1
                    ActivateMinion(ObjectGuid(instance->GetGuidData(2)), true);    // VaultWalker2
                    ActivateMinion(ObjectGuid(instance->GetGuidData(3)), true);    // VaultWalker3
                    ActivateMinion(ObjectGuid(instance->GetGuidData(4)), false);    // VaultWalker4
