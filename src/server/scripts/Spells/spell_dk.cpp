...
class spell_dk_anti_magic_shell_self : public SpellScriptLoader
{
    public:
        ...
        class spell_dk_anti_magic_shell_self_AuraScript : public AuraScript
        {
            ...
            void Absorb(AuraEffect* /*aurEff*/, DamageInfo & dmgInfo, uint32 & absorbAmount)
            {
                absorbAmount = std::min(CalculatePct(dmgInfo.GetDamage(), absorbPct), absorbAmount);
            }
            ...
            {
                // other immunities are handled in Unit::IsImmunedToSpellEffect, banish need extra handling
            ...
            void Register() override
            {
                ...
                OnEffectApply += AuraEffectApplyFn(spell_dk_anti_magic_shell_self_AuraScript::HandleOnEffectApply, EFFECT_1, SPELL_AURA_MOD_IMMUNE_AURA_APPLY_SCHOOL, AURA_EFFECT_HANDLE_REAL);
                OnEffectRemove += AuraEffectRemoveFn(spell_dk_anti_magic_shell_self_AuraScript::HandleOnEffectRemove, EFFECT_1, SPELL_AURA_MOD_IMMUNE_AURA_APPLY_SCHOOL, AURA_EFFECT_HANDLE_REAL);
            }
        };
    ...
    public:
        ...
        class spell_dk_blood_gorged_AuraScript : public AuraScript
        {
            ...
            void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
            {
                ...
                int32 bp = int32(eventInfo.GetDamageInfo()->GetDamage());
        ...
        class spell_dk_death_grip_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                if (Unit* target = GetHitUnit())
                {
                    ...
                    {
                        GetCaster()->SendSpellMiss(GetCaster(), GetSpellInfo()->Id, SpellMissInfo::SPELL_MISS_IMMUNE);
                        return;
                    }                        

                    if (!target->HasAuraType(SPELL_AURA_DEFLECT_SPELLS)) // Deterrence
                    {
                        // interrupt spell if grip made target move and clears MotionMaster if Confused or Feared
                        if (target->isMoving())
                        {
...
class spell_dk_death_pact : public SpellScriptLoader
{
    public:
        ...
        class spell_dk_death_pact_SpellScript : public SpellScript
        {
                ...
                if (Player* player = GetCaster()->ToPlayer())
                {
                    ...
                    for (Unit::ControlList::const_iterator itr = player->m_Controlled.begin(); itr != player->m_Controlled.end(); ++itr)
                        if (Creature* undeadPet = (*itr)->ToCreature())
                            ...
                            {
                                // druid cyclone
                                undeadPet->RemoveAurasDueToSpell(33786);
                                return SPELL_CAST_OK;
                            }
            ...
            {
                // Raise Dead(summon ghul)
                caster->GetSpellHistory()->SendCooldownEvent(sSpellMgr->GetSpellInfo(46584));
            }
            ...
            void Register() override
            {
                ...
                AfterCast += SpellCastFn(spell_dk_death_pact_SpellScript::HandleAfterCast);
            }
        ...
        class spell_dk_death_strike_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                if (Unit* target = GetHitUnit())
                {
                    ...
                    uint32 per_disease_bonus = 100; // 100%
                    if (AuraEffect const* aurEff = GetCaster()->GetAuraEffect(64736, EFFECT_0, GetCaster()->GetGUID()))
                        per_disease_bonus = 100 + aurEff->GetAmount(); // 120%
                    bp *= per_disease_bonus / 100;
...
public:
    ...
    class spell_dk_raise_ally_SpellScript : public SpellScript
    {
        ...
        void SendText()
        {
            ...
            if (caster && original)
                original->MonsterWhisper(TEXT_RISE_ALLY, caster, true);
        }
