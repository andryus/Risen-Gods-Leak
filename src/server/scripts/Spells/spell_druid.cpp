    ...
    public:
        ...
        class spell_dru_lifebloom_AuraScript : public AuraScript
        {
            ...
            void AfterRemove(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
            {
                ...
                int32 healAmount = aurEff->GetBaseAmount();

                if (Unit* caster = GetCaster())
                {
                    healAmount = caster->SpellHealingBonusDone(NULL, sSpellMgr->GetSpellInfo(SPELL_DRUID_LIFEBLOOM_FINAL_HEAL), healAmount, HEAL);
                    ...
                    //! Gift of Nature
                    if (AuraEffect* eff = caster->GetAuraEffectOfRankedSpell(17104, EFFECT_0, caster->GetGUID()))
                        AddPct(healAmount, eff->GetAmount());
                }
