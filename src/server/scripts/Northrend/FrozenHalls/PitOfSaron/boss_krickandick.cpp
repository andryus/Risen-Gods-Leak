    ...
    public:
        ...
        struct boss_ickAI : public BossAI
        {
            ...
            void EnterCombat(Unit* /*who*/)
            {
                ...
                events.ScheduleEvent(EVENT_MIGHTY_KICK, 20*IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_TOXIC_WASTE, 5*IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_SHADOW_BOLT, 10*IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_SPECIAL, urand(30, 35)*IN_MILLISECONDS);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_TOXIC_WASTE:
                            ...
                            events.ScheduleEvent(EVENT_TOXIC_WASTE, urand(7, 10)*IN_MILLISECONDS);
                            break;
                        ...
                        case EVENT_MIGHTY_KICK:
                            ...
                            events.ScheduleEvent(EVENT_MIGHTY_KICK, 25*IN_MILLISECONDS);
                            return;
                        case EVENT_SPECIAL:
                            me->SetControlled(false, UNIT_STATE_STUNNED);
                            ...
                            events.ScheduleEvent(EVENT_SPECIAL, urand(23, 28)*IN_MILLISECONDS);
                            break;
                        case EVENT_EXPLOSIVE_BARRAGE:
                            ...
                            events.ScheduleEvent(EVENT_MOVE, 21*IN_MILLISECONDS);
                            break;
