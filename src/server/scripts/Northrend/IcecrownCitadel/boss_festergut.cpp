...
void DoRemoveAuraOnAllPlayerInInstanceFestergut(InstanceScript* instance, uint32 spellId)
{
    ...
    public:
        ...
        struct boss_festergutAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                DoRemoveAuraOnAllPlayerInInstanceFestergut(instance, SPELL_INOCULATED);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_GAS_SPORE:
                            ...
                            events.ScheduleEvent(EVENT_GAS_SPORE, 40*IN_MILLISECONDS);
                            events.RescheduleEvent(EVENT_VILE_GAS, urand(28000, 35000));
                            break;
                        case EVENT_GASTRIC_BLOAT:
                            DoCastVictim(SPELL_GASTRIC_BLOAT);
                            events.ScheduleEvent(EVENT_GASTRIC_BLOAT, 10*IN_MILLISECONDS);
                            break;
                        case EVENT_BERSERK:
