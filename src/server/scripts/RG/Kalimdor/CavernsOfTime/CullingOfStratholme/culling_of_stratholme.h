...
enum Actions
{
    ACTION_SET_AGGRESSIVE        = 1,
    ACTION_DESPAWN               = 2,
    ACTION_ARTHAS_BEGIN_INTRO    = 3,
    ACTION_ARTHAS_BEGIN_NO_INTRO = 4,
};
...
Position const ChromieExitFlyPos = {2318.16f, 1554.60f, 169.68f, 4.47f};
Position const TimeGuardianSummonPos = {2318.97f, 1268.79f, 132.68f, 0.27531f};
