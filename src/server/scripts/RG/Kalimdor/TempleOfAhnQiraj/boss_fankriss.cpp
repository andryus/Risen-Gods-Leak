...
class boss_fankriss : public CreatureScript
{
    public:
        ...
        struct boss_fankrissAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                MortalWound_Timer     = urand(10, 15) * IN_MILLISECONDS;
                SpawnHatchlings_Timer =  urand(6, 12) * IN_MILLISECONDS;
                SpawnSpawns_Timer     = urand(15, 45) * IN_MILLISECONDS;
            }
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                if (MortalWound_Timer <= diff)
                {
                    ...
                    MortalWound_Timer = urand(10, 20) * IN_MILLISECONDS;
                } 
                else 
                ...
                if (HealthAbovePct(3))
                {
                    if (SpawnHatchlings_Timer <= diff)
                    {
                        ...
                        SpawnHatchlings_Timer = urand(45, 60) * IN_MILLISECONDS;
                    } 
                    else 
