...
enum Gameobjects
{
    GO_LARGE_OBSIDIAN_CHUNK = 181069
};
...
public:
    ...
    struct aqsentinelAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            me->SummonGameObject(GO_LARGE_OBSIDIAN_CHUNK, me->GetPositionX() + 5.0f, me->GetPositionY(), me->GetPositionZ(), me->GetOrientation(), 0, 0, 0, 0, 12000);
            Talk(SAY_DEATH);
        }
    };
