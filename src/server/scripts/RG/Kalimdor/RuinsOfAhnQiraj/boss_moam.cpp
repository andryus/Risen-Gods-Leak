    ...
    public:
        ...
        struct boss_moamAI : public BossAI
        {
            ...
            void Reset() override
            {
                ...
                _isStonePhase = false;
                events.ScheduleEvent(EVENT_STONE_PHASE, 90 * IN_MILLISECONDS);
            }
            ...
            void DoAction(int32 action) override
            {
                switch (action)
                {
                    ...
                    case ACTION_STONE_PHASE_START:
                    {
                        ...
                        events.ScheduleEvent(EVENT_STONE_PHASE_END, 90 * IN_MILLISECONDS);
                        break;
                    }
                    default:
                        break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_DRAIN_MANA:
                        {
                            ...
                            events.ScheduleEvent(EVENT_DRAIN_MANA, urand(5, 15) * IN_MILLISECONDS);
                            break;
                        }
                        default:
                            break;
