...
public:
    ...
    struct boss_cannon_master_willeyAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            Shoot_Timer          =  1 * IN_MILLISECONDS;
            Pummel_Timer         =  7 * IN_MILLISECONDS;
            KnockAway_Timer      = 11 * IN_MILLISECONDS;
            SummonRifleman_Timer = 15 * IN_MILLISECONDS;
        }

        void JustDied(Unit* /*killer*/) override
        {
            me->SummonCreature(11054, ADD_1X, ADD_1Y, ADD_1Z, ADD_1O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
            me->SummonCreature(11054, ADD_2X, ADD_2Y, ADD_2Z, ADD_2O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
            me->SummonCreature(11054, ADD_3X, ADD_3Y, ADD_3Z, ADD_3O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
            me->SummonCreature(11054, ADD_4X, ADD_4Y, ADD_4Z, ADD_4O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
            me->SummonCreature(11054, ADD_5X, ADD_5Y, ADD_5Z, ADD_5O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
            me->SummonCreature(11054, ADD_7X, ADD_7Y, ADD_7Z, ADD_7O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
            me->SummonCreature(11054, ADD_9X, ADD_9Y, ADD_9Z, ADD_9O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (Pummel_Timer <= diff)
            {
                ...
                Pummel_Timer = 12 * IN_MILLISECONDS;
            ...
            if (KnockAway_Timer <= diff)
            {
                ...
                KnockAway_Timer = 14 * IN_MILLISECONDS;
            ...
            if (SummonRifleman_Timer <= diff)
            {
                switch (rand32() % 9)
                {
                    ...
                    case 2:
                        me->SummonCreature(11054, ADD_3X, ADD_3Y, ADD_3Z, ADD_3O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
                        me->SummonCreature(11054, ADD_4X, ADD_4Y, ADD_4Z, ADD_4O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
                        me->SummonCreature(11054, ADD_6X, ADD_6Y, ADD_6Z, ADD_6O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
                        break;
                    case 3:
                        me->SummonCreature(11054, ADD_4X, ADD_4Y, ADD_4Z, ADD_4O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
                        me->SummonCreature(11054, ADD_5X, ADD_5Y, ADD_5Z, ADD_5O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
                    ...
                    case 4:
                        me->SummonCreature(11054, ADD_5X, ADD_5Y, ADD_5Z, ADD_5O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
                        me->SummonCreature(11054, ADD_6X, ADD_6Y, ADD_6Z, ADD_6O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
                        me->SummonCreature(11054, ADD_8X, ADD_8Y, ADD_8Z, ADD_8O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
                        break;
                    case 5:
                        me->SummonCreature(11054, ADD_6X, ADD_6Y, ADD_6Z, ADD_6O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
                        me->SummonCreature(11054, ADD_7X, ADD_7Y, ADD_7Z, ADD_7O, TEMPSUMMON_TIMED_DESPAWN, 240 * IN_MILLISECONDS);
                ...
                SummonRifleman_Timer = 30 * IN_MILLISECONDS;
