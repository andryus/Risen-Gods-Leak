    ...
    public:
        ...
        struct boss_magmadarAI : public BossAI
        {
            ...
            void EnterCombat(Unit* victim) override
            {
                ...
                events.ScheduleEvent(EVENT_FRENZY,    30 * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_PANIC,     20 * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_LAVA_BOMB, 12 * IN_MILLISECONDS);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_PANIC:
                            ...
                            events.ScheduleEvent(EVENT_PANIC, 35 * IN_MILLISECONDS);
                            break;
