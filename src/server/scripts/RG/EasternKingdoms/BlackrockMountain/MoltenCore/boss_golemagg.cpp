    ...
    public:
        ...
        struct boss_golemaggAI : public BossAI
        {
            ...
            void EnterCombat(Unit* victim) override
            {
                ...
                events.ScheduleEvent(EVENT_PYROBLAST, 7 * IN_MILLISECONDS);
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& /*damage*/) override
            {
                ...
                events.ScheduleEvent(EVENT_EARTHQUAKE, 3 * IN_MILLISECONDS);
            }
    ...
    public:
        ...
        struct npc_core_ragerAI : public ScriptedAI
        {
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& /*damage*/) override
            {
                ...
                if (Creature* pGolemagg = ObjectAccessor::GetCreature(*me, ObjectGuid(instance->GetGuidData(BOSS_GOLEMAGG_THE_INCINERATOR))))
                {
