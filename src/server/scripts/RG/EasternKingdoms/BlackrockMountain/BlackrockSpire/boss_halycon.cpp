    ...
    public:
        ...
        struct boss_halyconAI : public BossAI
        {
            ...
            void EnterCombat(Unit* who) override
            {
                ...
                events.ScheduleEvent(EVENT_REND,   urand(17,20) * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_THRASH, urand(10,12) * IN_MILLISECONDS);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_REND:
                            ...
                            events.ScheduleEvent(EVENT_REND, urand(8,10) * IN_MILLISECONDS);
                            break;
                        case EVENT_THRASH:
