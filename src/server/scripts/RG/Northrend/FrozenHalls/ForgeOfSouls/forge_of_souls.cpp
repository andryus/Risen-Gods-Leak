...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        if (creature->GetEntry() == NPC_JAINA_PART1)
            player->AddGossipItem(GOSSIP_SYLVANAS_ITEM, 0, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        else
            player->AddGossipItem(GOSSIP_SYLVANAS_ITEM, 1, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
