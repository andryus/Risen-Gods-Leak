...
enum DataTypes
{
    ...
    DATA_THE_DAMNED,
    DATA_SPIDER_ATTACK,
    DATA_FROSTWYRM_RIGHT,
    DATA_FROSTWYRM_LEFT,
    DATA_SINDRAGOSA_SPAWN,
    DATA_SINDRAGOSA_CAN_SPAWN,
    DATA_MAX_ATTEMPTS,
    DATA_PROFESSOR_PUTRICIDE_HC,
    DATA_BLOOD_QUEEN_LANA_THEL_HC,
    DATA_SINDRAGOSA_HC,
    DATA_SAURFANG_DONE,
    DATA_DARKFALLEN_ALIVE,
    DATA_BLOOD_WING_ENTRANCE,
    DATA_ARTHAS_TELEPORTER_UNLOCK,
    DATA_BLOOD_QUEEN_LANATHEL_TRIGGER,
...
enum CreaturesIds
{
    ...
    NPC_NERUBER_BROODKEEPER                     = 36725,
    NPC_NERUBER_BROODKEEPER_H                   = 38058,
    ...
    NPC_SE_JAINA_PROUDMOORE                     = 37188,    // SE means Saurfang EndEvent
    NPC_SE_MURADIN_BRONZEBEARD                  = 37200,
    NPC_SE_KING_VARIAN_WRYNN                    = 37879,    // SE means Saurfang EndEvent
    NPC_SE_HIGH_OVERLORD_SAURFANG               = 37187,    // SE means Saurfang EndEvent
    ...
    // Blood-Queen Lana'thel Start Event NPC for Blood Prince
    NPC_BLOOD_QUEEN_LANA_THEL_TRIGGER           = 38004,
    ...
    NPC_WORLD_TRIGGER_OLD                       = 15384,

    // Generic
    NPC_INVISIBLE_STALKER                       = 30298,
    NPC_ORB_STALKER                             = 38463
};
...
enum GameObjectsIds
{
    ...
    // Putricide Trash
    GO_SPIRIT_ALARM_5                       = 201888,
    GO_SPIRIT_ALARM_6                       = 201889,
    ...
    // General
    GO_RELEASE_DOOR_FROST_WING              = 201919,
    GO_RELEASE_DOOR_BLOOD_WING              = 201920,
};
