...
public:
    ...
    struct boss_heiganAI : public BossAI
    {
        ...
        void EnterCombat(Unit* who)
        {
            ...
            {
                for (Player& player : pInstance->GetPlayers())
                {
        ...
        void EnterPhase(Phases newPhase)
        {
            ...
            else
            {
                ...
                DoCastSelf(SPELL_PLAGUE_CLOUD, true);
            ...
            void HandleScript(SpellEffIndex /*eff*/)
            {
                ...
                if (GetHitDamage() >= int32(GetHitPlayer()->GetHealth()))
                    if (InstanceScript* instance = caster->GetInstanceScript())
                        if (Creature* Heigan = ObjectAccessor::GetCreature(*caster, ObjectGuid(instance->GetGuidData(DATA_HEIGAN))))
