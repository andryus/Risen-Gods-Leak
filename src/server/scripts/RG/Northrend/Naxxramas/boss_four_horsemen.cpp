    ...
    public:
        Creature* getHorsemanHandle(Horseman who) const
        {
            if (_which == who)
                ...
                return ObjectAccessor::GetCreature(*me, ObjectGuid(instance->GetGuidData(who)));
        }
        ...
        void BeginEncounter()
        {
            ...
            if (me->GetMap()->GetPlayers().empty()) // sanity check
                ResetEncounter();
    ...
    public:
        ...
        struct boss_four_horsemen_baronAI : public boss_four_horsemen_baseAI
        {
            ...
            void BeginFighting() override
            {
                ...
                {
                    if (Unit* nearest = me->FindNearestPlayer(5000.0f))
                    {
                ...
                events.ScheduleEvent(EVENT_UNHOLYSHADOW, urand(3, 7) * IN_MILLISECONDS);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_UNHOLYSHADOW:
                            ...
                            events.ScheduleEvent(EVENT_UNHOLYSHADOW, urand(10, 30) * IN_MILLISECONDS);
                            break;
                    }
                }
        ...
        {
            return new boss_four_horsemen_baronAI(creature);
        }
};
    ...
    public:
        ...
        struct boss_four_horsemen_thaneAI : public boss_four_horsemen_baseAI
        {
            ...
            void BeginFighting() override
            {
                ...
                events.ScheduleEvent(EVENT_BERSERK, 10 * MINUTE * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_MARK, 24 * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_METEOR, urand(10, 15) * IN_MILLISECONDS);
            }
            void _UpdateAI(uint32 diff) override
            {
                if (!_ourMovementFinished || !UpdateVictim())
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_METEOR:
                            ...
                            events.ScheduleEvent(EVENT_METEOR, urand(13, 17) * IN_MILLISECONDS);
                            break;
                    }
                }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new boss_four_horsemen_thaneAI(creature);
        }
};
    ...
    public:
        ...
        struct boss_four_horsemen_ladyAI : public boss_four_horsemen_baseAI
        {
            ...
            void BeginFighting() override
            {
                events.ScheduleEvent(EVENT_BERSERK, 10 * MINUTE * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_MARK, 24 * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_VOIDZONE, urand(5, 10) * IN_MILLISECONDS);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_VOIDZONE:
                            ...
                            events.ScheduleEvent(EVENT_VOIDZONE, urand(12, 18) * IN_MILLISECONDS);
                            break;
                    }
                }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new boss_four_horsemen_ladyAI(creature);
        }
};
    ...
    public:
        ...
        struct boss_four_horsemen_sirAI : public boss_four_horsemen_baseAI
        {
            ...
            void BeginFighting() override
            {
                events.ScheduleEvent(EVENT_BERSERK, 10 * MINUTE * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_MARK, 24 * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_HOLYWRATH, urand(13, 18) * IN_MILLISECONDS);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_HOLYWRATH:
                            ...
                            events.ScheduleEvent(EVENT_HOLYWRATH, urand(10, 18) * IN_MILLISECONDS);
                            break;
                    }
                }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new boss_four_horsemen_sirAI(creature);
        }
};
