...
{
    generic_boss_controllerAI(Creature* creature) : BossAI(creature, DATA_SKARVALD_DALRONN_EVENT)
    {
        OtherBossData = 0;
    ...
    {
        if (Creature* otherBoss = ObjectAccessor::GetCreature(*me, ObjectGuid(instance->GetGuidData(OtherBossData))))
        {
