...
enum Achievements
{
    ACHIEVMENT_BATTLE_FOR_MOUNT_HYJAL = 695,
};
...
public:
    ...
    {
        npc_ancient_wispAI(Creature* creature) : ScriptedAI(creature), instance(creature->GetInstanceScript()) { }
...
public:
    ...
    struct boss_archimondeAI : public BossAI
    {
        ...
        void JustDied(Unit* killer) override
        {
            ...
            instance->DoCompleteAchievement(ACHIEVMENT_BATTLE_FOR_MOUNT_HYJAL);
