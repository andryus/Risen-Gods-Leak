...
public:
    ...
    struct boss_ouroAI : public BossAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.RescheduleEvent(EVENT_BIRTH, 500);
            events.RescheduleEvent(EVENT_SWEEP, 15000);
            events.RescheduleEvent(EVENT_SANDBLAST, 20000);
            events.RescheduleEvent(EVENT_SUBMERGE, 90000);
            events.RescheduleEvent(EVENT_MEELE_CHECK, 10000, 0, PHASE_MEELE);
            events.RescheduleEvent(EVENT_SUMMON_SCRABS, 45000);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_SUMMON_SCRABS:
                        ...
                        {
                            if (Creature* scrab = me->SummonCreature(NPC_SCRAB, me->GetPositionX() + (irand(-25, 25)), me->GetPositionY() + (irand(-25, 25)), me->GetPositionZ(), me->GetOrientation() + (irand(-M_PI, M_PI)), TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 5000))
                    ...
                    case EVENT_SUBMERGE:
                        ...
                        events.RescheduleEvent(EVENT_SUBMERGE_END, 30000);
                        events.RescheduleEvent(EVENT_QUAKE, 5000);
                    ...
                    case EVENT_SUBMERGE_END:
                        ...
                        events.RescheduleEvent(EVENT_SANDBLAST, 20000);
                        events.RescheduleEvent(EVENT_SUBMERGE, 90000);
                        events.RescheduleEvent(EVENT_MEELE_CHECK, 10000);
                    ...
                    case EVENT_BOLDER:
                        ...
                        events.RescheduleEvent(EVENT_BOLDER, 3000);
                        break;
                }
            }
            ...
            if (me->GetHealthPct() <= 20 && !me->HasAura(SPELL_BERSERK))
            {
                ...
                events.RescheduleEvent(EVENT_BOLDER, 2500);
            }
