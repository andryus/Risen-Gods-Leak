...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        if (InstanceScript* instance = creature->GetInstanceScript())
        {
            ...
            {
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, player->GetOptionTextWithEntry(GOSSIP_BLY, 1), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);
        ...
        if (InstanceScript* instance = creature->GetInstanceScript())
        {
            switch (instance->GetData(EVENT_PYRAMID))
            {
                case PYRAMID_KILLED_ALL_TROLLS:
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, player->GetOptionTextWithEntry(GOSSIP_WEEGLI, 0), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);
...
public:
    ...
    bool OnTrigger(Player* player, const AreaTriggerEntry* /*at*/) override
    {
        ...
        pZumrah->SetImmuneToPC(false);
        pZumrah->AI()->AttackStart(player);
        return true;
    }
