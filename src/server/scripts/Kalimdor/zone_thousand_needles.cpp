...
public:
    ...
    struct npc_kanatiAI : public npc_escortAI
    {
        ...
        void WaypointReached(uint32 waypointId) override
        {
            ...
            case 0:
                Talk(SAY_KAN_START);
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_PVP_ATTACKABLE); //Trinity Bug bei summoned->AI()->AttackStart(me); umgehen....
                DoSpawnGalak();
                break;
            case 1:
                if (Player* player = GetPlayerForEscort())
                    player->GroupEventHappens(QUEST_PROTECT_KANATI, me);
                me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_PVP_ATTACKABLE); //Trinity Bug bei summoned->AI()->AttackStart(me); umgehen....
