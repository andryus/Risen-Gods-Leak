            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_COMPLETE:
                    {
                        ...
                        me->VisitAnyNearbyObject<WorldObject, Trinity::ContainerAction>(50.0f, ClusterList, objects);
