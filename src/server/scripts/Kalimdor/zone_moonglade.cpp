...
enum ClintarSpirit
{
    ...
    CLINTAR_SPIRIT_SAY_1            = 0,
    CLINTAR_SPIRIT_SAY_2            = 1,
    CLINTAR_SPIRIT_SAY_3            = 2,
    CLINTAR_SPIRIT_SAY_4            = 3,
    CLINTAR_SPIRIT_SAY_5            = 4,
    CLINTAR_SPIRIT_SAY_6            = 5,
    ASPECT_OF_RAVEN_YELL            = 0,
};
...
public:
    ...
    public:
        ...
        void IsSummonedBy(Unit* /*summoner*/) override
        {
            ...
            me->VisitAnyNearbyObject<Player, Trinity::ContainerAction>(5.0f, playerOnQuestList, checker);
            ...
            if (EventOnWait && EventTimer <= diff)
            {
                ...
                switch (CurrWP)
                {
                    case 0:
                        ...
                        {
                            case 0:
                                Talk(CLINTAR_SPIRIT_SAY_1, player);
                                EventTimer = 8000;
                                Step = 1;
                                break;
                            case 1:
                                Talk(CLINTAR_SPIRIT_SAY_2, player);
                                EventOnWait = false;
                                break;
                        }
                        break;
                    case 6:
                        switch (Step)
                        {
                            ...
                            case 1:
                                ...
                                Talk(CLINTAR_SPIRIT_SAY_3, player);
                                EventOnWait = false;
                                break;
                        }
                        break;
                    ...
                    case 16:
                        ...
                        {
                            case 0:
                                Talk(CLINTAR_SPIRIT_SAY_4, player);
                                EventTimer = 15000;
                                Step = 1;
                                break;
                            case 1:
                        ...
                        switch (Step)
                        {
                            case 0:
                                if (Creature* mob = me->SummonCreature(ASPECT_RAVEN, AspectRavenSummon, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 2000))
                                {
                                    ...
                                    mob->AI()->Talk(ASPECT_OF_RAVEN_YELL, player);
                                }
                                EventTimer = 2000;
                                Step = 1;
                                break;
                    ...
                    case 25:
                        ...
                        {
                            case 0:
                                Talk(CLINTAR_SPIRIT_SAY_5, player);
                                EventTimer = 4000;
                                Step = 1;
                                break;
                            case 1:
                    ...
                    case 40:
                        ...
                        {
                            case 0:
                                Talk(CLINTAR_SPIRIT_SAY_6, player);
