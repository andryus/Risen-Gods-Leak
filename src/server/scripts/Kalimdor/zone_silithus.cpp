            ...
            if (eventEnd == false)
            {
                switch (AnimationCount)
                {
                    ...
                    case 10:
                        ...
                        Merithra->GetMotionMaster()->MovePoint(0, -8065.0f, 1530.0f, 6.61f);
                        break;
                    case 11:
                    ...
                    case 12:
                        Merithra->SetCanFly(true);
                        Merithra->GetMotionMaster()->MovePoint(0, -8100.0f, 1530.0f, 50.0f);
                        break;
                    case 13:
                        break;
                    case 14:
                    ...
                    case 18:
                        ...
                        Arygos->GetMotionMaster()->MovePoint(0, -8065.0f, 1530.0f, 6.61f);
                        break;
                    case 19:
                    ...
                    case 20:
                        Arygos->SetCanFly(true);
                        Arygos->GetMotionMaster()->MovePoint(0, -8095.0f, 1530.0f, 50.0f);
                        break;
                    case 21:
                        break;
                    case 22:
                        ...
                        break;
                    case 23:
                        Caelestrasz->GetMotionMaster()->MovePoint(0, -8065.0f, 1530.0f, 2.61f);
                        Arygos->SetVisible(false);
                        Arygos->GetMotionMaster()->MovePoint(0, -8034.535f, 1535.14f, 2.61f);
                        break;
                    case 24:
                    ...
                    case 26:
                        ...
                        Caelestrasz->GetMotionMaster()->MovePoint(0, -8065.0f, 1530.0f, 7.61f);
                        break;
                    case 27:
                    ...
                    case 28:
                        ...
                        break;
                    case 29:
                        Caelestrasz->GetMotionMaster()->MovePoint(0, -8095.0f, 1530.0f, 50.0f);
