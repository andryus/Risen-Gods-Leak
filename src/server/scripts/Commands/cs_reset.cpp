...
namespace chat { namespace command { namespace handler {
    ...
    bool HandleResetAchievementsCommand(ChatHandler* handler, char const* args)
    {
        Player* target;
    ...
    bool HandleResetHonorCommand(ChatHandler* handler, char const* args)
    {
        Player* target;
    ...
    bool HandleResetLevelCommand(ChatHandler* handler, char const* args)
    {
        Player* target;
        if (!handler->extractPlayerTarget((char*)args, &target))
            return false;
    ...
    bool HandleResetSpellsCommand(ChatHandler* handler, char const* args)
    {
        Player* target;
        ObjectGuid targetGuid;
    ...
    bool HandleResetStatsCommand(ChatHandler* handler, char const* args)
    {
        Player* target;
        if (!handler->extractPlayerTarget((char*)args, &target))
            return false;
    ...
    bool HandleResetTalentsCommand(ChatHandler* handler, char const* args)
    {
        Player* target;
        ObjectGuid targetGuid;
        std::string targetName;
    ...
    bool HandleResetAllCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
...
void AddSC_reset_commandscript()
{
    ...
    new LegacyCommandScript("cmd_reset_achievements",   HandleResetAchievementsCommand,     true);
    new LegacyCommandScript("cmd_reset_honor",          HandleResetHonorCommand,            true);
    new LegacyCommandScript("cmd_reset_level",          HandleResetLevelCommand,            true);
    new LegacyCommandScript("cmd_reset_spells",         HandleResetSpellsCommand,           true);
    new LegacyCommandScript("cmd_reset_stats",          HandleResetStatsCommand,            true);
    new LegacyCommandScript("cmd_reset_talents",        HandleResetTalentsCommand,          true);
    new LegacyCommandScript("cmd_reset_all",            HandleResetAllCommand,              true);
}
