...
namespace chat { namespace command { namespace handler {
    ...
    bool HandleTitlesCurrentCommand(ChatHandler* handler, char const* args)
    {
    ...
    bool HandleTitlesAddCommand(ChatHandler* handler, char const* args)
    {
        // number or [name] Shift-click form |color|Htitle:title_id|h[name]|h|r
        char* id_p = handler->extractKeyFromLink((char*)args, "Htitle");
        if (!id_p)
    ...
    bool HandleTitlesRemoveCommand(ChatHandler* handler, char const* args)
    {
        // number or [name] Shift-click form |color|Htitle:title_id|h[name]|h|r
        char* id_p = handler->extractKeyFromLink((char*)args, "Htitle");
        if (!id_p)
    ...
    bool HandleTitlesSetMaskCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
...
void AddSC_titles_commandscript()
{
    ...
    new LegacyCommandScript("cmd_titles_add",       HandleTitlesAddCommand,         false);
    new LegacyCommandScript("cmd_titles_current",   HandleTitlesCurrentCommand,     false);
    new LegacyCommandScript("cmd_titles_remove",    HandleTitlesRemoveCommand,      false);
    new LegacyCommandScript("cmd_titles_set_mask",  HandleTitlesSetMaskCommand,     false);
}
