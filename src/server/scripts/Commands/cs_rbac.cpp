...
namespace chat { namespace command { namespace handler {
    ...
    RBACCommandData* ReadParams(ChatHandler* handler, char const* args, bool checkParams = true)
    {
        if (!args)
            return NULL;
    ...
    bool HandleRBACPermGrantCommand(ChatHandler* handler, char const* args)
    {
    ...
    bool HandleRBACPermDenyCommand(ChatHandler* handler, char const* args)
    {
        RBACCommandData* command = ReadParams(handler, args);
    ...
    bool HandleRBACPermRevokeCommand(ChatHandler* handler, char const* args)
    {
        RBACCommandData* command = ReadParams(handler, args);
    ...
    bool HandleRBACPermListCommand(ChatHandler* handler, char const* args)
    {
    ...
    bool HandleRBACListPermissionsCommand(ChatHandler* handler, char const* args)
    {
        uint32 id = 0;
...
void AddSC_rbac_commandscript()
{
    ...
    new LegacyCommandScript("cmd_rbac_list",            HandleRBACListPermissionsCommand,   false);

    new LegacyCommandScript("cmd_rbac_account_list",    HandleRBACPermListCommand,          false);
    new LegacyCommandScript("cmd_rbac_account_grant",   HandleRBACPermGrantCommand,         false);
    new LegacyCommandScript("cmd_rbac_account_deny",    HandleRBACPermDenyCommand,          false);
    new LegacyCommandScript("cmd_rbac_account_revoke",  HandleRBACPermRevokeCommand,        false);
}
