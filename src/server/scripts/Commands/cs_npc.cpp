...
#define FLAGS_EXTRA_COUNT 23
    ...
    EnumName<CreatureFlagsExtra> const flagsExtra[FLAGS_EXTRA_COUNT] =
    {
        ...
        CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_IMMUNITY_TURN_EVIL),
    ...
    bool HandleNpcReset(ChatHandler* handler, char const* /*args*/)
    {
        Player* player = handler->GetSession()->GetPlayer();

        // accept only explicitly selected target (not implicitly self targeting case)
        Unit* selection = handler->getSelectedUnit();
        if (player->GetTarget() && selection)
        {
            if (selection->GetTypeId() != TYPEID_UNIT || selection->IsPet())
            {
            ...
            if (selection->IsAlive())
                if (Creature* target = selection->ToCreature())
                    target->OnEvade();
            return true;
        }
    ...
    bool HandleNpcAddCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
        ...
        if (MotionTransport* trans = chr->GetMotionTransport())
        {
        ...
        Creature* creature = Creature::Create(id, map, Position(x, y, z, o), chr->GetPhaseMaskForSpawn());
        if (!creature)
            return false;
        ...
        creature = Creature::LoadFromDB(db_guid, map);
        if (!creature)
            return false;
    ...
    bool HandleNpcAddVendorItemCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcAddMoveCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcSetAllowMovementCommand(ChatHandler* handler, char const* /*args*/)
    {
    ...
    bool HandleNpcSetEntryCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcSetLevelCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcDeleteCommand(ChatHandler* handler, char const* args)
    {
        Creature* unit = NULL;
    ...
    bool HandleNpcDeleteVendorItemCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcSetFactionIdCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcSetFlagCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcSetDataCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    //npc follow handling
    bool HandleNpcFollowCommand(ChatHandler* handler, char const* /*args*/)
    {
        Player* player = handler->GetSession()->GetPlayer();
        Creature* creature = handler->getSelectedCreature();
    ...
    bool HandleNpcInfoCommand(ChatHandler* handler, char const* /*args*/)
    {
    ...
    bool HandleNpcNearCommand(ChatHandler* handler, char const* args)
    {
    ...
    bool HandleNpcMoveCommand(ChatHandler* handler, char const* args)
    {
        uint32 lowguid = 0;
        ...
        if (creature)
            creature->GetMotionMaster()->MovePoint(0, x, y, z, true);
    ...
    //play npc emote
    bool HandleNpcPlayEmoteCommand(ChatHandler* handler, char const* args)
    {
    ...
    bool HandleNpcSetModelCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    */
    bool HandleNpcSetMoveTypeCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcSetPhaseCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcSetSpawnDistCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    //spawn time handling
    bool HandleNpcSetSpawnTimeCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcSayCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcTextEmoteCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcUnFollowCommand(ChatHandler* handler, char const* /*args*/)
    {
        Player* player = handler->GetSession()->GetPlayer();
        Creature* creature = handler->getSelectedCreature();
    ...
    bool HandleNpcWhisperCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
        ...
        ObjectGuid receiver_guid = ObjectGuid((uint64)atoull(receiver_str));

        // check online security
        Player* receiver = ObjectAccessor::GetPlayer(*creature, receiver_guid);
    ...
    bool HandleNpcYellCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcAddTempSpawnCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    //npc tame handling
    bool HandleNpcTameCommand(ChatHandler* handler, char const* /*args*/)
    {
    ...
    bool HandleNpcAddFormationCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcSetLinkCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleNpcRemoveCorpseCommand(ChatHandler* handler, char const* args)
    {
        Creature* creature = handler->getSelectedCreature();
    ...
    bool HandleNpcDoCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
        ...
        {
            handler->SendSysMessage(LANG_AI_NOT_ENABLED);
            handler->SetSentErrorMessage(true);
            return false;
        }

        uint32 actionId = (uint32)atol(args);

        if (actionId == 0)
        {
            handler->PSendSysMessage(LANG_COMMAND_INVALID_PARAMETER, "actionId");
            handler->SetSentErrorMessage(true);
            return false;
        }

        if (!creature->AI()->DoChatAction(handler->GetSession()->GetPlayer(), actionId))
        {
            handler->SendSysMessage(LANG_COMMAND_ACTION_FAILED);
            handler->SetSentErrorMessage(true);
            return false;
        }
    ...
    bool HandleNpcAddWeaponCommand(ChatHandler* /*handler*/, char const* /*args*/)
    {
        /*if (!*args)
        return false;
    ...
    bool HandleNpcSetNameCommand(ChatHandler* /*handler*/, char const* /*args*/)
    {
        /* Temp. disabled
        if (!*args)
        return false;
    ...
    bool HandleNpcSetSubNameCommand(ChatHandler* /*handler*/, char const* /*args*/)
    {
        /* Temp. disabled
...
void AddSC_npc_commandscript()
{
    ...
    new LegacyCommandScript("cmd_npc_info",             HandleNpcInfoCommand,               false);
    new LegacyCommandScript("cmd_npc_reset",            HandleNpcReset,                     false);
    new LegacyCommandScript("cmd_npc_near",             HandleNpcNearCommand,               false);
    new LegacyCommandScript("cmd_npc_move",             HandleNpcMoveCommand,               false);
    new LegacyCommandScript("cmd_npc_playemote",        HandleNpcPlayEmoteCommand,          false);
    new LegacyCommandScript("cmd_npc_say",              HandleNpcSayCommand,                false);
    new LegacyCommandScript("cmd_npc_textemote",        HandleNpcTextEmoteCommand,          false);
    new LegacyCommandScript("cmd_npc_whisper",          HandleNpcWhisperCommand,            false);
    new LegacyCommandScript("cmd_npc_yell",             HandleNpcYellCommand,               false);
    new LegacyCommandScript("cmd_npc_tame",             HandleNpcTameCommand,               false);
    new LegacyCommandScript("cmd_npc_do",               HandleNpcDoCommand,                 false);

    new LegacyCommandScript("cmd_npc_add",              HandleNpcAddCommand,                false);
    new LegacyCommandScript("cmd_npc_add_formation",    HandleNpcAddFormationCommand,       false);
    new LegacyCommandScript("cmd_npc_add_item",         HandleNpcAddVendorItemCommand,      false);
    new LegacyCommandScript("cmd_npc_add_move",         HandleNpcAddMoveCommand,            false);
    new LegacyCommandScript("cmd_npc_add_temp",         HandleNpcAddTempSpawnCommand,       false);
    //new LegacyCommandScript("cmd_npc_add_weapon",     HandleNpcAddWeaponCommand,          false);

    new LegacyCommandScript("cmd_npc_delete",           HandleNpcDeleteCommand,             false);
    new LegacyCommandScript("cmd_npc_delete_item",      HandleNpcDeleteVendorItemCommand,   false);

    new LegacyCommandScript("cmd_npc_follow",           HandleNpcFollowCommand,             false);
    new LegacyCommandScript("cmd_npc_follow_stop",      HandleNpcUnFollowCommand,           false);

    new LegacyCommandScript("cmd_npc_set_allowmove",    HandleNpcSetAllowMovementCommand,   false);
    new LegacyCommandScript("cmd_npc_set_entry",        HandleNpcSetEntryCommand,           false);
    new LegacyCommandScript("cmd_npc_set_factionid",    HandleNpcSetFactionIdCommand,       false);
    new LegacyCommandScript("cmd_npc_set_flag",         HandleNpcSetFlagCommand,            false);
    new LegacyCommandScript("cmd_npc_set_level",        HandleNpcSetLevelCommand,           false);
    new LegacyCommandScript("cmd_npc_set_link",         HandleNpcSetLinkCommand,            false);
    new LegacyCommandScript("cmd_npc_set_model",        HandleNpcSetModelCommand,           false);
    new LegacyCommandScript("cmd_npc_set_movetype",     HandleNpcSetMoveTypeCommand,        false);
    new LegacyCommandScript("cmd_npc_set_phase",        HandleNpcSetPhaseCommand,           false);
    new LegacyCommandScript("cmd_npc_set_spawndist",    HandleNpcSetSpawnDistCommand,       false);
    new LegacyCommandScript("cmd_npc_set_spawntime",    HandleNpcSetSpawnTimeCommand,       false);
    new LegacyCommandScript("cmd_npc_set_data",         HandleNpcSetDataCommand,            false);
    //new LegacyCommandScript("cmd_npc_set_name",       HandleNpcSetNameCommand,            false);
    //new LegacyCommandScript("cmd_npc_set_subname",    HandleNpcSetSubNameCommand,         false);

    new LegacyCommandScript("cmd_npc_remove_corpse",    HandleNpcRemoveCorpseCommand,       false);
}
