...
namespace chat { namespace command { namespace handler {
    ...
    bool HandleSendMailCommand(ChatHandler* handler, char const* args)
    {
    ...
    // Send items by mail
    bool HandleSendItemsCommand(ChatHandler* handler, char const* args)
    {
    ...
    /// Send money by mail
    bool HandleSendMoneyCommand(ChatHandler* handler, char const* args)
    {
    ...
    bool HandleSendMessageCommand(ChatHandler* handler, char const* args)
    {
        /// - Find the player
        Player* player;
...
void AddSC_send_commandscript()
{
    ...
    new LegacyCommandScript("cmd_send_items",       HandleSendItemsCommand,     true);
    new LegacyCommandScript("cmd_send_mail",        HandleSendMailCommand,      true);
    new LegacyCommandScript("cmd_send_message",     HandleSendMessageCommand,   true);
    new LegacyCommandScript("cmd_send_money",       HandleSendMoneyCommand,     true);
}
