...
namespace chat { namespace command { namespace handler {
    ...
    bool HandleGroupSummonCommand(ChatHandler* handler, char const* args)
    {
        Player* target;
    ...
    bool HandleGroupLeaderCommand(ChatHandler* handler, char const* args)
    {
        Player* player = NULL;
        Group* group = NULL;
    ...
    bool HandleGroupDisbandCommand(ChatHandler* handler, char const* args)
    {
        Player* player = NULL;
        Group* group = NULL;
        ObjectGuid guid = ObjectGuid::Empty;
    ...
    bool HandleGroupRemoveCommand(ChatHandler* handler, char const* args)
    {
        Player* player = NULL;
        Group* group = NULL;
        ObjectGuid guid = ObjectGuid::Empty;
    ...
    bool HandleGroupJoinCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
    ...
    bool HandleGroupListCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (auto target_info = player::PlayerCache::Get(nameTarget))
        {
            nameTarget = target_info.name;
...
void AddSC_group_commandscript()
{
    ...
    new LegacyCommandScript("cmd_group_leader",     HandleGroupLeaderCommand,   false);
    new LegacyCommandScript("cmd_group_disband",    HandleGroupDisbandCommand,  false);
    new LegacyCommandScript("cmd_group_remove",     HandleGroupRemoveCommand,   false);
    new LegacyCommandScript("cmd_group_join",       HandleGroupJoinCommand,     false);
    new LegacyCommandScript("cmd_group_list",       HandleGroupListCommand,     false);
    new LegacyCommandScript("cmd_group_summon",     HandleGroupSummonCommand,   false);
}
