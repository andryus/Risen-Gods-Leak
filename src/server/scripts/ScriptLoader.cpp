...
// core
void AddSC_player_mute();
void AddSC_command_scripts();
void AddSC_api();
void AddSC_Scripting();
...
#ifdef RG_SCRIPTS
void AddSC_alterac_mountains_rg();
...
void AddSC_eversong_woods_rg();
void AddSC_ghostlands_rg();
void AddSC_hinterlands_rg();
void AddSC_ironforge_rg();
void AddSC_isle_of_queldanas_rg();
void AddSC_loch_modan_rg();
void AddSC_redridge_mountains_rg();
void AddSC_silvermoon_city_rg();
void AddSC_silverpine_forest_rg();
void AddSC_stormwind_city_rg();
void AddSC_stranglethorn_vale_rg();
void AddSC_swamp_of_sorrows_rg();
void AddSC_tirisfal_glades_rg();
void AddSC_undercity_rg();
void AddSC_western_plaguelands_rg();
void AddSC_westfall_rg();
void AddSC_wetlands_rg();
#endif
...
void AddSC_teldrassil_rg();
void AddSC_the_barrens_rg();
void AddSC_thousand_needles_rg();
void AddSC_thunder_bluff_rg();
void AddSC_ungoro_crater_rg();
void AddSC_winterspring_rg();
#endif
...
void AddSC_crystalsong_forest_rg();
...
void AddSC_area_warsong_hold_rg();

// Events Icecrown
void AddSC_area_sindragosas_fall_rg();

// Events The Storm Peaks
void AddSC_area_garms_bane_rg();

// Events Hellfire Peninsula
...
#ifdef RG_SCRIPTS
    AddSC_deathknight_spell_scripts_rg();
    AddSC_druid_spell_scripts_rg();
    AddSC_generic_spell_scripts_rg();
    AddSC_hunter_spell_scripts_rg();
    AddSC_item_spell_scripts_rg();
    AddSC_mage_spell_scripts_rg();
    AddSC_paladin_spell_scripts_rg();
    AddSC_pet_spell_scripts_rg();
    AddSC_priest_spell_scripts_rg();
    AddSC_quest_spell_scripts_rg();
    AddSC_rogue_spell_scripts_rg();
    AddSC_shaman_spell_scripts_rg();
    AddSC_warlock_spell_scripts_rg();
    AddSC_warrior_spell_scripts_rg();
#endif
}
...
#ifdef RG_SCRIPTS
    AddSC_alterac_mountains_rg();
    AddSC_arathi_highlands_rg();
    AddSC_blasted_lands_rg();
    AddSC_burning_steppes_rg();
    AddSC_duskwood_rg();
    AddSC_eastern_plaguelands_rg();
    AddSC_eversong_woods_rg();
    AddSC_ghostlands_rg();
    AddSC_hinterlands_rg();
    AddSC_ironforge_rg();
    AddSC_isle_of_queldanas_rg();
    AddSC_loch_modan_rg();
    AddSC_redridge_mountains_rg();
    AddSC_silvermoon_city_rg();
    AddSC_silverpine_forest_rg();
    AddSC_stormwind_city_rg();
    AddSC_stranglethorn_vale_rg();
    AddSC_swamp_of_sorrows_rg();
    AddSC_tirisfal_glades_rg();
    AddSC_undercity_rg();
    AddSC_western_plaguelands_rg();
    AddSC_westfall_rg();
    AddSC_wetlands_rg();
#endif
...
void AddKalimdorScripts()
{
    ...
    AddSC_ashenvale_rg();
    AddSC_azshara_rg();
    AddSC_azuremyst_isle_rg();
    AddSC_bloodmyst_isle_rg();
    AddSC_darkshore_rg();
    AddSC_desolace_rg();
    AddSC_durotar_rg();
    AddSC_dustwallow_marsh_rg();
    AddSC_felwood_rg();
    AddSC_feralas_rg();
    AddSC_moonglade_rg();
    AddSC_mulgore_rg();
    AddSC_orgrimmar_rg();
    AddSC_silithus_rg();
    AddSC_stonetalon_mountains_rg();
    AddSC_tanaris_rg();
    AddSC_teldrassil_rg();
    AddSC_the_barrens_rg();
    AddSC_thousand_needles_rg();
    AddSC_thunder_bluff_rg();
    AddSC_ungoro_crater_rg();
    AddSC_winterspring_rg();
#endif
...
#ifdef RG_SCRIPTS
    AddSC_blades_edge_mountains_rg();
    AddSC_hellfire_peninsula_rg();
    AddSC_nagrand_rg();
    AddSC_netherstorm_rg();
    AddSC_shadowmoon_valley_rg();
    AddSC_shattrath_city_rg();
    AddSC_terokkar_forest_rg();
    AddSC_zangarmarsh_rg();

    // Events Hellfire Peninsula
    AddSC_stair_of_destiny_rg();
#endif
...
void AddNorthrendScripts()
{
    ...
    AddSC_strand_of_anicents();

#ifdef RG_SCRIPTS
    AddSC_borean_tundra_rg();
    AddSC_crystalsong_forest_rg();
    AddSC_dalaran_rg();
    AddSC_dragonblight_rg();
    AddSC_grizzly_hills_rg();
    AddSC_howling_fjord_rg();
    AddSC_icecrown_rg();
    AddSC_sholazar_basin_rg();
    AddSC_storm_peaks_rg();
    AddSC_zuldrak_rg();

    AddSC_argent_tournament();
    AddSC_battle_for_the_undercity();

    // Events Borean Tundra
    AddSC_area_kaskala_rg();
    AddSC_area_valiance_keep_rg();
    AddSC_area_warsong_hold_rg();

    // Events Icecrown
    AddSC_area_sindragosas_fall_rg();

    // Events The Storm Peaks
    AddSC_area_garms_bane_rg();
#endif
...
void AddCustomScripts()
{
    ...
    AddSC_custom_rg();
    AddSC_custom_poll();
    AddSC_custom_antispam();
    AddSC_custom_event_sheep_of_death();
    AddSC_custom_olympia();
    AddSC_custom_birthday();
    AddSC_custom_startguild();
    AddSC_custom_ruby_opening();
    AddSC_custom_premium();
#endif
    AddSC_rg_scripts();
}
