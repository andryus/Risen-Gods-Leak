...
struct DynamicTreeIntersectionCallback
{
    ...
    {
        //@todo this should actually stop at first hit, but sometimes our raycast algorithm finds polygons behind first
        // (possibly related to wmo with overlapping groups) 
        did_hit = obj.intersectRay(r, distance, false, phase_mask);
        return did_hit;
    }
